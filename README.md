...
<table>
		...
		<tr>
			<td><b>BMP2GIF.PAS</b></td>
			<td>Cette commande permet de convertir une image BitMap (.BMP) en format GIF (Graphics Interchange Format).</td>
		</tr>
		<tr>
			<td><b>BMP2HDR.PAS</b></td>
		...
		<tr>
			<td><b>BMP2MSP.PAS</b></td>
			<td>Cette commande permet de convertir une image BitMap (.BMP) monochrome en format MSP (.MSP) de Microsoft Paint.</td>
		</tr>
		<tr>
		...
		<tr>
			<td><b>BMP2PNG.PAS</b></td>
			<td>Cette commande permet de convertir une image BitMap (.BMP) en format PNG (.PNG, Portable Network Graphics).</td>
		</tr>
		<tr>
			<td><b>BMP2PPM.PAS</b></td>
			<td> Cette commande permet de convertir une image BitMap (.BMP) en format d'image PPM (Portable PixMap).</td>
		</tr>
		<tr>
		...
		<tr>
			<td><b>BMP2TGA.PAS</b></td>
			<td>Cette commande permet de convertir une image BitMap (.BMP) en format Targa (.TGA) utilisé sur Amiga, Atari ST et MS-DOS.</td>
		</tr>
		<tr>
			<td><b>BMP2TIFF.PAS</b></td>
		...
		<tr>
			<td><b>CSV2XLS.PAS</b></td>
			<td>Cette commande permet de convertir un fichier CSV en XLS de Microsoft Excel.</td>
		</tr>
		<tr>
		...
		<tr>
			<td><b>DBF2CPP.PAS</b></td>
			<td>Cette commande permet de convertir un fichier .DBF (DBase III) en format C++.</td>
		</tr>		
		<tr>
			<td><b>DBF2CS.PAS</b></td>
			<td>Cette commande permet de convertir un fichier .DBF (DBase III) en format C#.</td>
		</tr>	
		<tr>			
			<td><b>DBF2CSP.PAS</b></td>
			<td>Cette commande permet de convertir un fichier .DBF (DBase III) en format CSP (C Server Pages).</td>
		</tr>	
		<tr>
		...
		<tr>
			<td><b>DBF2JSON.PAS</b></td>
			<td>Cette commande permet de convertir un fichier .DBF (DBase III) en format JSON.</td>
		</tr>		
		<tr>
			<td><b>DBF2JS.PAS</b></td>
			<td>Cette commande permet de convertir un fichier .DBF (DBase III) en format JavaScript.</td>
		</tr>	
		<tr>			
		...
		<tr>
			<td><b>DISKPC.PAS</b></td>
			<td>Cette commande permet de copier des fichiers dans une image disque PC FAT.</td>
		</tr>
	        <tr>
		...
		<tr>
			<td><b>H8D.PAS</b></td>
			<td>Cette commande permet de lancer l'utilitaire de gestion d'images disque Heath/Zenith H8D (HDOS).</td>
		</tr>
		<tr>
			<td><b>HALT.PAS</b></td>
		...
		<tr>
			<td><b>ICO2BAS.PAS</b></td>
			<td>Cette commande permet de transformer un icône (.ICO) en code source BASIC.</td>
		</tr>
		<tr>
			<td><b>ICO2C.PAS</b></td>
		...
		<tr>
			<td><b>SYS.PAS</b></td>
			<td>Cette commande permet de transferer les fichiers systèmes.</td>
		</tr>
		<tr>
		...
		<tr>
			<td><b>TIMEOUT.PAS</b></td>
			<td>Cette commande d'attendre le nombre de secondes spécifiés. Cette commande est inspiré de Windows.</td>
		</tr>
	        <tr>
			<td><b>TOD.PAS</b></td>
		...
		<tr>
			<td><b>TSV2ASM.PAS</b></td>
			<td>Cette commande permet de convertir un fichier TSV (Tab-Separated Values) en code source Assembleur.</td>
		</tr>
		<tr>
			<td><b>TSV2BAS.PAS</b></td>
		...
		<tr>
			<td><b>TSV2CPP.PAS</b></td>
			<td>Cette commande permet de convertir un fichier TSV en code source C++.</td>
		</tr>
		<tr>
			<td><b>TSV2CS.PAS</b></td>
...
<h2>Licence</h2>
<ul>
 <li>Le code source est publié sous la licence <a href="https://github.com/gladir/corail/blob/master/LICENSE">MIT</a>.</li>
 <li>Le paquet original est publié sous la licence <a href="https://github.com/gladir/corail/blob/master/LICENSE">MIT</a>.</li>
</ul>
